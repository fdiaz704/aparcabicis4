...
1. [ ] Eliminar código muerto de `main_screen.dart` (`_HistoryTab`, `_ProfileTab`, `_SettingsTab`); sacar `lib/prueba.md` a `docs/`.
2. [ ] Renombrar dominio: `BikeStation`→`Parking`, pantallas/rutas/textos "estación"→"aparcamiento".
